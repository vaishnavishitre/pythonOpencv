...
# Use a file dialog box to select an image
img_path = easygui.fileopenbox(filetypes=["*.jpg", "*.jpeg", "*.png"])
...
cv2.imshow("MINI PROJECT HISTORICAL IMAGES INTO COLORFUL IMAGES", result)
